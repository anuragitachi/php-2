  ...
  <body>
    ...
    <div class="row" id="nav">
      <div class="large-3 columns">
        <a href="index.html"><img src="09.png" id="paws_logo" /></a>
      </div>
      <div class="large-9 columns">
        <ul class="inline-list right" id="upper_nav_items">
          <li><a href="index.html">Home</a></li>
          <li><a href="sell.php">Adoptable Pets</a></li>
          <li><a href="contact.html">contact us</a></li>
          <li><a href="Account.php">Manage Account</a></li>
          <li><a href="signup.html">Members</a></li>
      ...
      <div class="large-12 columns">
        ...
        <div class="row">
          <div class="large-6 columns">
            <p> &copy; ANURAG choudhary | LOVELY profestional  University | Spring 2019</p>
          </div>
          <div class="large-6 columns">
